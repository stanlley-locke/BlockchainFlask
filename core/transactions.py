...
class TransactionManager:
    ...
    def create_transaction(self, sender, recipient, amount, private_key, fee=None):
    ...
    def get_pending_transactions(self, limit=None):
        ...
        try:
            # Get transactions from database that aren't in blocks yet
            query = """
    ...
    def process_transactions(self, transactions):
        ...
        try:
            for transaction in transactions:
                # Skip coinbase transactions for balance updates
                if transaction.get('is_coinbase', False):
